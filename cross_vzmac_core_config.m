...
function cross_vzmac_core_config(this_block)

  % Revision History:
  %
  %   23-May-2014  (12:52 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /tools/designs/CASPER/projects/leda/davidm/adc16/s6_gateware/cross_vzmac_core.vhd
  %
  %

  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('cross_vzmac_core');
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('cross_vzmac_core.vhd');
